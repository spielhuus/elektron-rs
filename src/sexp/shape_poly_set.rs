...
pub enum POLYGON_MODE {
    PM_FAST,
    PM_STRICTLY_SIMPLE,
}

pub struct SHAPE_LINE_CHAIN;
 ...
 */
pub struct SHAPE_POLY_SET {
    // m_polys: Vec<POLYGON>,
}

impl SHAPE_POLY_SET {

    pub fn InflateWithLinkedHoles(&self, aFactor: f64, aCircleSegmentsCount: u32, aFastMode: POLYGON_MODE) {
    }

    ///< Creates a new empty polygon in the set and returns its index
    pub fn NewOutline(&self) {
    }
    
    //Original pub Append(&mut self, x: f64, y: f64, int aOutline = -1, int aHole = -1, bool aAllowDuplication = false );
    ...
    pub fn AddOutline(&mut self,  aOutline: &SHAPE_LINE_CHAIN) {
    }

    ///< Return the number of outlines in the set
    pub fn OutlineCount(&self) -> usize { 
        //TODO self.m_polys.size() 
        0
    }
    
    pub fn CPolygon(&self, aIndex: usize ) -> Vec<SHAPE_LINE_CHAIN> {
        // self.m_polys[aIndex] //TODO: implement
        Vec::new()
    }

    ///< Delete \a aIdx-th polygon from the set.
    pub fn DeletePolygon(&mut self, aIdx: usize ) {
        //TODO: implement
    }
}
