...
fn it_works() {
    ...
    assert_eq!(vec!["Node(trace)", "Value(value1)", "Value(value2)", "Node(node3)", "Value(value3)", "Value(value4)", "End()", "Node(node5)", "Value(value5)", "Text(RAW TEXT VALUE)", "End()", "End()"], builder.nodes);
}
#[test]
fn with_params() {
    let mut builder = Builder::new();
    ...
    assert_eq!(vec!["Node(trace)", "Value(param value)", "Value(value2)", "Node(node3)", "Value(value3)", "Value(value4)", "End()", "Node(node5)", "Value(value5)", "Text(RAW TEXT VALUE)", "End()", "End()"], builder.nodes);
}
#[test]
...
fn with_params_text() {
    ...
    let value = String::from(r"param value");
    parse_sexp!(builder, ("trace" !{value.as_str()} "value2" ("node3" "value3" "value4") ("node5" "value5" r"RAW TEXT VALUE")));
    assert_eq!(vec!["Node(trace)", "Text(param value)", "Value(value2)", "Node(node3)", "Value(value3)", "Value(value4)", "End()", "Node(node5)", "Value(value5)", "Text(RAW TEXT VALUE)", "End()", "End()"], builder.nodes);
}
#[test]
fn with_property() {
    let mut builder = Builder::new();
