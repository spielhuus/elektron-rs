...
impl Circuit {
    fn get_includes(&self, key: String) -> Result<IndexMap<String, String>, Error> {
...
mod tests {
    ...
    fn load_4007() {
        ...
        assert_eq!("files/spice/CD4007.lib", include.get("CMOS4007").unwrap());
    }
    #[test]
