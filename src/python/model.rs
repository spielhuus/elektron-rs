...
impl R {
    ...
    pub fn new(reference: String, value: String) -> (Self, Element) {
        (R {}, Element::new(reference, String::from("Device:R"), value, 1, None))
    }
}
...
impl C {
    #[new]
    pub fn new(reference: String, value: String) -> (Self, Element) {
        (C {}, Element::new(reference, String::from("Device:C"), value, 1, None))
    }
}
...
impl Gnd {
    ...
    pub fn new() -> (Self, Element) {
        (Gnd {}, Element::new(String::from("GND"), String::from("power:GND"), String::from("GND"), 1, None))
    }
}
...
impl Power {
    ...
    pub fn new(reference: String) -> (Self, Element) {
        (Power {}, Element::new(reference.to_string(), format!("power:{}", &reference), reference, 1, None))
    }
}
